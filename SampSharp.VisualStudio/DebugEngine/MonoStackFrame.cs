...
namespace SampSharp.VisualStudio.DebugEngine
{
    public class MonoStackFrame : IDebugStackFrame2, IDebugExpressionContext2
    {
        ...
        ///     The name is the description of this evaluation context. It is typically something that can be parsed by an
        ...
        ///     The engine sample only supports locals and parameters so the only task here is to check the names in those
        ///     collections.
        /// </summary>
        ...
        /// <param name="pichError">The error.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        public int ParseText(string code, enum_PARSEFLAGS dwFlags, uint nRadix, out IDebugExpression2 expression,
            out string error, out uint pichError)
        {
            var frame = _frame();
            error = null;
            pichError = 0;
        ...
        ///     Calling the IDebugProperty2::EnumChildren method with appropriate filters can retrieve the local variables, method
        ///     parameters, registers, and "this"
        ...
        /// </summary>
        /// <param name="ppExprCxt">The expression context.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        ...
        /// </summary>
        /// <param name="pbstrLanguage">The PBSTR language.</param>
        /// <param name="pguidLanguage">The pguid language.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
        public int GetLanguageInfo(ref string pbstrLanguage, ref Guid pguidLanguage)
        {
            pbstrLanguage = "C#";
            pguidLanguage = Guids.CSharpLanguageService;
            return S_OK;
        }
        ...
        /// </summary>
        /// <param name="addrMin">The address minimum.</param>
        /// <param name="addrMax">The address maximum.</param>
        /// <returns>If successful, returns S_OK; otherwise, returns an error code.</returns>
