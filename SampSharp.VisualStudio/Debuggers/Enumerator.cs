...
{
    /// <summary>
    ///     Common enumerator pattern for VS interfaces.
    /// </summary>
    /// <typeparam name="TObjectType">Type of enumerating object.</typeparam>
    /// <typeparam name="TEnumType">Type of enumerator interface.</typeparam>
    public class Enumerator<TObjectType, TEnumType> where TEnumType : class
    {
        private readonly TObjectType[] _data;
        private uint _position;

        public Enumerator(TObjectType[] data)
        {
            _data = data;
            _position = 0;
        }
        ...
        public int Next(uint celt, TObjectType[] rgelt, out uint celtFetched)
        {
